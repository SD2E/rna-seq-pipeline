...
echo container_exec ${CONTAINER_IMAGE} python /src/mongo_query_and_basic_metrics.py ${experiment_id} ${DEBUG_preproc_max}
container_exec ${CONTAINER_IMAGE} python /src/mongo_query_and_basic_metrics.py ${experiment_id} ${DEBUG_preproc_max}
